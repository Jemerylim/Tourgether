...
const AcceptInvitation = () => {
    ...
    const checkInvitationStatus = async () => {
      ...
      try {
        ...
        const statusResponse = await axios.get(
          `http://localhost:5000/api/trips/${tripId}/status?userId=${userId}`,
  ...
  const handleAccept = async () => {
    ...
    try {
      ...
      await axios.post(
        `http://localhost:5000/api/trips/${tripId}/accept-invitation`,
        { userId },
        { headers: { Authorization: `Bearer ${authToken}` } }
      );
  ...
  const handleDecline = async () => {
    ...
    try {
      ...
      await axios.delete(
        `http://localhost:5000/api/trips/${tripId}/decline-invitation`,
        {
          headers: { Authorization: `Bearer ${authToken}` },
