...
const Profile = () => {
  ...
  const handleUpdateProfile = async (e) => {
    ...
    try {
      ...
      const updatedUserResponse = await axios.get("http://localhost:5000/api/users/profile", {
        headers: { Authorization: `Bearer ${token}` },
      });
    ...
    <div className="profile-container">
      ...
      {user && (
        <div className="profile-box">
          <img
            src={user?.profilePicture ? `http://localhost:5000/${user.profilePicture}` : "http://localhost:5000/uploads/profile-pic.jpg"}
            alt="Profile"
